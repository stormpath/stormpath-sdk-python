...
class TestFactor(TestCase):
    ...
    def setUp(self):
        ...
        self.factor = Factor(self.client, properties={
        ...
        self.challenge = Challenge(self.client, properties={
    ...
    def test_challenge_factor_google_authenticator_code(self, create):
        ...
        self.assertEqual(str(error.exception), 'When challenging a google-authenticator factor, activation code must be provided.')
    ...
    def test_create_factor_message_custom(self, create):
        ...
        create.assert_called_once_with(properties, challenge=True, expand=None)
