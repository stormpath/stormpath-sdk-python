...
class TestApplicationAccountLinkingPolicy(AccountBase):
    def test_application_with_default_account_linking_policy(self):
        self.assertIsInstance(self.app.account_linking_policy, AccountLinkingPolicy)
        self.assertEqual(self.app.account_linking_policy.status, self.app.account_linking_policy.STATUS_DISABLED)
        self.assertEqual(self.app.account_linking_policy.automatic_provisioning,
    ...
    def test_application_with_updating_account_linking_policy(self):
        self.assertIsInstance(self.app.account_linking_policy, AccountLinkingPolicy)
        self.app.account_linking_policy.status = self.app.account_linking_policy.STATUS_ENABLED
        self.app.account_linking_policy.automatic_provisioning = self.app.account_linking_policy.AUTOMATIC_PROVISIONING_ENABLED
        self.app.account_linking_policy.matching_property = self.app.account_linking_policy.MATCHING_PROPERTY_EMAIL

        self.app.account_linking_policy.save()
        self.app.account_linking_policy.refresh()

        self.assertIsInstance(self.app.account_linking_policy, AccountLinkingPolicy)
        self.assertEqual(self.app.account_linking_policy.status, self.app.account_linking_policy.STATUS_ENABLED)
        self.assertEqual(self.app.account_linking_policy.automatic_provisioning,
                         self.app.account_linking_policy.AUTOMATIC_PROVISIONING_ENABLED)
        self.assertEqual(self.app.account_linking_policy.matching_property,
